...
//                 // ✅ Reset quantity back to 1 (or 0 if stock empty)
//                 setQuantity(variantToUse.stock > 0 ? 1 : 0);
//               }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="flex flex-col pr-5">
            ...
            {/* <button
              ...
              disabled={isOutOfStock || isMaxInCart}
              className={`px-6 w-50 py-3 rounded-lg mb-4 transition ${isOutOfStock || isMaxInCart
                  ? "bg-gray-400 cursor-not-allowed"
                  : "bg-black text-white hover:bg-gray-800"
                }`}
            >
            ...
            <button
              ...
              disabled={!anyStockAvailable || isOutOfStock || isMaxInCart || !isVariantSelected}
