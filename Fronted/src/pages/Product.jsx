...
//   const allSizes = fproduct ? [...new Set(fproduct.variants.map((v) => v.size))] : [];
//   const allColors = fproduct ? [...new Set(fproduct.variants.map((v) => v.color))] : [];
...
//               navigation
//               spaceBetween={10}
//               className="w-full max-w-[500px] aspect-square rounded-xl"
//             >
//               {fproduct.images?.map((img) => (
//                 <SwiperSlide key={img}>
...
//                       src={img}
//                       alt={fproduct.name}
//                       className="w-full h-full object-contain rounded-xl shadow cursor-zoom-in"
//                     />
//                   </a>
//                 </SwiperSlide>
//               ))}
...
//                       src={img}
//                       alt="thumbnail"
//                       className="w-16 h-16 object-cover rounded border hover:ring-2 hover:ring-black"
//                     />
//                   </SwiperSlide>
//                 ))}
//               </Swiper>
...
//                 setIsAdding(false);
//               }}
//               disabled={!anyStockAvailable || isOutOfStock || isMaxInCart || isAdding}
//               className={`px-6 w-50 py-3 rounded-lg mb-4 transition ${!anyStockAvailable || isOutOfStock || isMaxInCart || isAdding
//                   ? "bg-gray-400 cursor-not-allowed"
//                   : "bg-black text-white hover:bg-gray-800"
//                 }`}
