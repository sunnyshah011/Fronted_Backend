      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={onSubmitHandler} className="space-y-4">
          ...
          <div>
            ...
            />
            {errors.gmail && (
              <p className="text-red-500 text-[12px] mt-1 ml-2">*{errors.gmail}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.password && (
              <p className="text-red-500 text-[12px] mt-1 ml-2">*{errors.password}</p>
            )}
          </div>
          ...
          {errors.agree && (
            <p className="text-red-500 text-[12px] ml-2">*{errors.agree}</p>
          )}
