...
//   //     formData.append("image", selectedFile); // MUST match multer field
//   //     formData.append("_id", orderId); // backend needs this
...
//     formData.append("_id", order._id); // use _id from order, not orderId
